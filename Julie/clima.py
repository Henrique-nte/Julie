...
def obter_previsao(dia='hoje'):
    try:
        ...
        if resposta.get("cod") != "200":
            ...
            print("Julie: Não consegui obter a previsão do tempo.")
            return
        ...
        if not previsoes:
            ...
            print("Julie: Sem dados de previsão disponíveis.")
            return
        ...
        print(f"julie: A previsão para {dia} em {CIDADE} é de {clima}, com temperatura de {temp:.0f} graus Celsius.")
